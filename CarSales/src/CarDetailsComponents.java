...
{
	private JLabel manufacturerLabel = new JLabel("Марка");
	private JLabel yearLabel = new JLabel("Година");
	private JLabel modelLabel = new JLabel("Модел");
	private JLabel priceLabel = new JLabel("Цена");
	private JLabel kmLabel = new JLabel("Изминати Километри");
	private JLabel infoLabel = new JLabel("Допълнителна Информация:");
