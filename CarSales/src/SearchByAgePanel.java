...
public class SearchByAgePanel extends JPanel implements ActionListener
{
	...
	private JLabel headingLabel = new JLabel("Търсене по години");
	private JLabel ageLabel = new JLabel("Години");
	...
	private JPanel agePanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
	private JPanel searchButtonsPanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
	...
	private void searchButtonClicked()
	{
		...
		if (carList.length > 0)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "Няма намерени данни", "Грешка", JOptionPane.WARNING_MESSAGE);
	}
}