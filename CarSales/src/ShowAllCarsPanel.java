...
public class ShowAllCarsPanel extends JPanel implements ActionListener, ChangeListener
{
	...
	private JLabel headingLabel = new JLabel("Покажи всички марки и модели");
	...
	private void nextButtonClicked()
	{
		if (currentIndex < carList.length - 1)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "Няма данни, не можете да продължите", "Грешка", JOptionPane.ERROR_MESSAGE);
	}
	...
	private void previousButtonClicked()
	{
		if (currentIndex > 0)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "Няма данни, не можете да се върнете назад", "Грешка", JOptionPane.ERROR_MESSAGE);
	}
}