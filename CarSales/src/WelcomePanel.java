...
public class WelcomePanel extends JPanel implements ChangeListener
{
	...
	private JLabel headingLabel = new JLabel("", JLabel.CENTER);
	...
	private void updateStats()
	{
		...
		carsLabel.setText("Общ брой коли: " + String.valueOf(cars));
		manufacturersLabel.setText("Общ брой марки: " + String.valueOf(manufacturers));
		avgPriceLabel.setText("Средна цена: " + String.valueOf(avgPrice));
		avgKmLabel.setText("Средно изминати километри: " + String.valueOf(avgKm));
		avgAgeLabel.setText("Средни години на коли: " + String.valueOf(avgAge));
		dataSizeLabel.setText("Размер на файла: " + size + " bytes");
