...
{
	private final String[] price = {"1-100000", "100001-200000", "200001-300000", "300001-400000", "400001-1200000"};
	private final String[] distance = {"1-10000", "10001-20000", "20001-30000", "30001-40000",
		"40001-50000", "50001-80000", "80001-100000", "100001-200000", "200001-300000", "300001-2000000"};
	private Car[] carList;
	private CarSalesSystem carSystem;
	private int currentIndex = 0;
	private JLabel headingLabel = new JLabel("Търсене по цена и изминато разстояние");
	private JLabel priceLabel = new JLabel("Цена(лв.)");
	private JLabel distanceLabel = new JLabel("Изминато разстояние(км.)");
